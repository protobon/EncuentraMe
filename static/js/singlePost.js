    ...
    window.displayPost = function () {
        fetchSinglePost().then(function(post) {
            ...
            if (postId.includes("lost")) {
                ...
                postLostAnimal.append('<div class="fb-share-button" data-href="' + url + '" data-layout="button" data-size="large"></div>');
                ...
                postFoundAnimal.append('<div class="fb-share-button" data-href="' + url + '" data-layout="button" data-size="large"></div>');
