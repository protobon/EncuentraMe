    ...
    window.displayPost = function () {
        fetchSinglePost().then(function(post) {
            ...
            if (postId.includes("lost")) {
                ...
                postLostAnimal.append('<div class="fb-share-button" data-href="' + url + '" data-layout="button" data-size="small"><a target="_blank" href="' + url + '" class="fb-xfbml-parse-ignore">Compartir</a></div>');
                ...
                postFoundAnimal.append('<div class="fb-share-button" data-href="' + url + '" data-layout="button" data-size="small"><a target="_blank" href="' + url + '" class="fb-xfbml-parse-ignore">Compartir</a></div>');
